...
|---|---|---|---|---|---|---|---|---|
| ⭐ [BebasDNS](https://github.com/bebasid/bebasdns/tree/main#bebasdns) | Layanan DNS oleh bebasid, [memblokir iklan dan *malware*](https://github.com/bebasid/bebasdns#daftar-blokir-dns--08092022) | `147.139.211.126` | `47.254.192.66` | `1753` | `2001:470:36:b90:beba:5::1d` | `2001:470:36:9be:ba5::1d` | `dns.bebasid.com/dns-query` | `dns.bebasid.com` |
| [BebasDNS Unfiltered](https://github.com/bebasid/bebasdns/tree/main#unfiltered) | [Tanpa pemblokiran apapun]() | - | - | - | - | - | `dns.bebasid.com/dns-query/unfiltered` | `unfiltered.dns.bebasid.com` |
| [BebasDNS Malware](https://github.com/bebasid/bebasdns/tree/main#malware) | [Memblokir *malware*](https://github.com/bebasid/bebasdns#daftar-blokir-dns--08092022) | - | - | - | - | - | `dns.bebasid.com/dns-query/malware` | `malware.dns.bebasid.com` |
| [BebasDNS Family](https://github.com/bebasid/bebasdns/tree/main#family) | [Memblokir *malware* & situs dewasa](https://github.com/bebasid/bebasdns#daftar-blokir-dns--08092022) | - | - | - | - | - | `dns.bebasid.com/dns-query/family` | `family.dns.bebasid.com` |
| [Cloudflare DNS](https://www.cloudflare.com/learning/dns/what-is-1.1.1.1/) | Layanan DNS oleh Cloudflare | `1.1.1.1` | `1.0.0.1` | - | `2606:4700:4700::1111` | `2606:4700:4700::1001` | `cloudflare-dns.com/dns-query` | `1dot1dot1dot1.cloudflare-dns.com` |
| [Cloudflare Secure DNS](https://blog.cloudflare.com/introducing-1-1-1-1-for-families/) | [Memblokir *malware*](https://one.one.one.one/family) | `1.1.1.2` | `1.0.0.2` | - | `2606:4700:4700::1112` | `2606:4700:4700::1002` | `security.cloudflare-dns.com/dns-query` | `security.cloudflare-dns.com` |
| [Cloudflare Family DNS](https://blog.cloudflare.com/introducing-1-1-1-1-for-families/) | [Memblokir *malware* & situs dewasa](https://one.one.one.one/family) | `1.1.1.3` | `1.0.0.3` | - | `2606:4700:4700::1113` | `2606:4700:4700::1003` | `family.cloudflare-dns.com/dns-query` | `family.cloudflare-dns.com` |
...
| UncensoredDNS | [Tanpa pemblokiran apapun](https://blog.uncensoreddns.org/about/) | `91.239.100.100` | `- | - | `2001:67c:28a4::` | - | `anycast.uncensoreddns.org/dns-query` | `anycast.uncensoreddns.org` |
