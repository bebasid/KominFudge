...
| Nama                                 | Catatan                                                                                       | Harga      |
|:------------------------------------:|:---------------------------------------------------------------------------------------------:| ---------- |
| [ProtonVPN](https://protonvpn.com)   | *Unlimited* Data, *Free plan* hanya memiliki 3 negara                                         | *Freemium* |
| [Windscribe](https://windscribe.com) | Terpengaruh oleh [BIX](Advanced-README.md#internet-exchange), 2GB/b jika tidak menambah email | *Freemium* |
...
4. [Accesser](https://github.com/URenko/Accesser) [Windows, macOS, Linux]
   
   > Aplikasi untuk menghilangkan TCP RST. Umumnya digunakan di Tiongkok.
5. [GhosTCP](https://github.com/macronut/ghostcp) [Windows]  
   
   > Mengamankan koneksi TCP.
6. [SpoofDPI](https://github.com/xvzc/SpoofDPI) [macOS, Linux]  
   
   > Menipu DPI-mu.
7. [Zapret](https://github.com/bol-van/zapret/blob/master/docs/readme.eng.md) [Linux, FreeBSD]  
...
8. [DPITunnel](https://github.com/nomoresat/DPITunnel-cli) [Linux, [Android](https://github.com/nomoresat/DPITunnel-android)]  
   
   > Solusi gratis, sederhana, dan serverless terhadap penyensoran untuk Linux
9. [Geneva](https://github.com/kkevsterrr/geneva) [Linux]  
